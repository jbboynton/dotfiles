...
alias rc="rubocop --color --config .rubocop.yml --extra-details --force-exclusion --format simple"
alias rcs="rubocop --color --config .rubocop.yml --extra-details --force-exclusion --format simple && bundle exec rspec"
