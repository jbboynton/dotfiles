alias aliases="vim ~/.zsh/configs/aliases.zsh"
alias app="open -a"
...
alias rmds="fd --hidden '^\.DS_Store$' --type f --exec-batch rm"
alias rmswp="fd --hidden --full-path '/var/tmp/.*\.sw.*' --type f --exec-batch rm"
